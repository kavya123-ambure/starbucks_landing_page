...
function change1() {
    ...
    document.getElementById('spiral').src = 'https://64.media.tumblr.com/7d64ef11ae4ade4cf3af6f00ad7fa93b/tumblr_okcvkujApG1txe8seo1_500.gifv';
    
}

function change2() {
    
    document.getElementById('pic').src = 'https://freepngimg.com/thumb/coffee/62120-coffee-frappuccino-drink-latte-starbucks-unicorn.png';
  
    document.getElementById('spiral').src = 'https://windowscustomization.com/wp-content/uploads/2018/08/ribbons.gif';
}

function change3() {
  
    document.getElementById('pic').src = 'https://freepngimg.com/thumb/starbucks/61291-cheesecake-frappuccino-milkshake-starbucks-cream-free-frame.png';
...
function change4() {
    ...
    document.getElementById('pic').src = 'https://freepngimg.com/thumb/starbucks/77325-frappuccino-drink-chocolate-starbucks-matcha-white.png';
  
    document.getElementById('spiral').src = 'https://media4.giphy.com/media/3o72EXihHbvvpzh6JW/giphy.gif?cid=ecf05e47ian2apilvm5eirbzu5ut1ia4bhue33ca6ogmslyu&ep=v1_gifs_related&rid=giphy.gif&ct=g';
...
function changeCircleColor(color) {
    const elements = ['.circle', '.small', '#facebook', '#twitter', '#instagram','.first-circle','.right-circle'];
